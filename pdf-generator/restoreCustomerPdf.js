...
// Rename original generateProductTable to generateSupervisorTable
code = code.replace('function generateProductTable(doc, quotationData, startY, isFactoryView = false)', 'function generateSupervisorTable(doc, quotationData, startY)');

// Create wrapper
const wrapper = `
function generateProductTable(doc, quotationData, startY, isFactoryView = false) {
  if (isFactoryView) {
    return generateSupervisorTable(doc, quotationData, startY);
  } else {
...
code = code.replace('module.exports = { generateProductTable };', wrapper + '\n' + customerCode + '\nmodule.exports = { generateProductTable };');
